...
>
    ...
    <div
        x-cloak
        x-show="opened"
        class="fixed z-[1000] mb-6 shadow-lg bg-white transition-all overflow-y-auto md:max-h-[calc(100%-2rem)] md:top-4 md:right-4 top-0 right-0 flex flex-col max-h-full h-screen w-full rounded-xl"
        x-bind:class="width"
    ...
    >
        ...
        {{-- <x-spinner-overlay wire:loading.class.remove="opacity-0" class="!items-start pt-[30%] pointer-events-none opacity-0 transition-opacity !bg-white" /> --}}
